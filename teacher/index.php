...
<div class="quick-action-card" 
     style="background:#ffffff; padding:20px; border-radius:12px; 
            box-shadow:0 4px 15px rgba(0,0,0,0.1); 
            display:flex; align-items:center; gap:20px; 
            margin:20px 0;">
    
    <a href="#selects_marks_year" class="action-link" style="display:flex; 
        align-items:center; gap:20px; text-decoration:none; color:#333; width:100%;">

        <!-- Icon Section -->
        <div class="action-icon" 
             style="width:55px; height:55px; background:linear-gradient(135deg, #4B79A1, #283E51); 
        ...
        <div class="action-content">
            <h3 style="margin:0; font-size:20px; color:#222;">Mark Attendance </h3>
            <p style="margin:2px 0 0; font-size:14px; color:#555;">
                View all Classes are  available
            </p>
        </div>

        <!-- Arrow -->
        <div class="action-arrow" style="margin-left:auto; font-size:22px; color:#666;">
            →
        </div>
...
<div class="container_timetable_timetable">
    ...
    <!-- View Toggles -->
    <div class="flex justify-center mb-8 space-x-4"       id="selects_marks_year">
        ...
        <div class="year-filter-container"     >
            ...
            <div class="year-buttons">
                <?php foreach ($available_years as $year): ?>
                   <a href="?academic_year=<?php echo urlencode($year); ?>#select_mark" 
